...
.lab-hero-art{position:absolute;right:1%;top:5%;width:45%;height:90%}.lab-orbit{position:absolute;inset:15% 2% 12%;border:2px solid rgba(82,102,255,.55);border-radius:50%;transform:rotate(-8deg);box-shadow:0 0 18px rgba(72,92,255,.45),0 0 38px rgba(187,48,255,.25)}.lab-device{position:absolute;left:22%;top:34%;width:58%;height:42%;border-radius:25px;transform:perspective(520px) rotateX(57deg) rotateZ(-8deg);background:linear-gradient(145deg,#193cff 0%,#17135f 50%,#7424ff 100%);border:2px solid #22e4ff;box-shadow:0 0 13px #10d7ff,0 0 34px #5338ff,0 0 68px rgba(228,43,255,.48),inset 0 0 23px rgba(255,255,255,.22)}.lab-device:after{content:"";position:absolute;inset:10px;border-radius:15px;background:radial-gradient(circle at 52% 44%,rgba(230,53,255,.72),transparent 31%),radial-gradient(circle at 42% 63%,rgba(40,94,255,.62),transparent 39%),linear-gradient(145deg,#08122b,#08091f 65%,#1b0a31)}
.lab-social{position:absolute;width:46px;height:46px;border-radius:10px;display:grid;place-items:center;color:#fff;border:1px solid rgba(255,255,255,.24);box-shadow:0 0 14px currentColor;font-size:.72rem;font-weight:1000;z-index:5}.lab-social.ig{left:8%;top:22%;background:linear-gradient(145deg,#7725ff,#ff247e)}.lab-social.yt{right:17%;top:25%;background:linear-gradient(145deg,#ff164b,#d90852)}.lab-social.stat{right:2%;top:11%;background:linear-gradient(145deg,#0877ff,#6a22ff)}.lab-social.like{left:48%;top:0;background:linear-gradient(145deg,#8c21ff,#ff24bd)}.lab-social.chat{left:50%;bottom:4%;background:linear-gradient(145deg,#006fff,#5f2cff)}
...
<section class="lab-page active" data-view="painel">
    <div class="lab-hero-row">
        <section class="lab-hero">
            ...
            <div class="lab-hero-art" aria-hidden="true"><div class="lab-orbit"></div><div class="lab-device"></div><div class="lab-social ig">IG</div><div class="lab-social yt">▶</div><div class="lab-social stat">↗</div><div class="lab-social like">♥</div><div class="lab-social chat">●</div></div>
        </section>
