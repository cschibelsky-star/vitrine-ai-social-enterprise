...
.lab-main{min-width:0;padding:12px 18px 86px}.lab-top{display:flex;align-items:center;justify-content:space-between;gap:14px;min-height:48px;border-bottom:1px solid rgba(122,116,190,.10);margin-bottom:10px}.lab-top-left small{display:block;color:#8f9bb7;font-size:.63rem}.lab-top-actions{display:flex;align-items:center;gap:10px}.lab-bell{width:34px;height:34px;display:grid;place-items:center;border-left:1px solid rgba(255,255,255,.1);border-right:1px solid rgba(255,255,255,.1)}.lab-bell svg{width:18px;height:18px}.lab-profile{display:flex;align-items:center;gap:8px}.lab-avatar{width:34px;height:34px;border-radius:50%;display:grid;place-items:center;background:linear-gradient(145deg,#50236d,#0b7cff);border:2px solid #fff;font-size:.6rem;font-weight:900}.lab-profile b{display:block;font-size:.7rem}.lab-profile span{display:block;color:#99a6c2;font-size:.58rem}
...
.lab-chip{display:inline-flex;padding:4px 7px;border-radius:999px;border:1px solid rgba(34,211,238,.25);background:rgba(34,211,238,.08);color:#a5f3fc;font-size:.58rem}.lab-chip.warn{border-color:rgba(245,158,11,.35);color:#fde68a}.lab-chip.ok{border-color:rgba(16,185,129,.35);color:#86efac}.lab-chip.off{border-color:rgba(148,163,184,.25);color:#cbd5e1}.lab-social-icon{width:34px;height:34px;border-radius:10px;display:grid;place-items:center;margin-bottom:10px;border:1px solid rgba(255,255,255,.2);box-shadow:0 0 16px rgba(99,102,241,.18)}.lab-social-icon svg{width:19px;height:19px}.lab-social-icon.instagram{background:linear-gradient(145deg,#7c3aed,#ec4899,#f97316)}.lab-social-icon.facebook{background:linear-gradient(145deg,#1877f2,#0b57d0)}.lab-social-icon.tiktok{background:linear-gradient(145deg,#111827,#0f172a);box-shadow:-2px 0 0 rgba(34,211,238,.55),2px 0 0 rgba(244,63,94,.5)}.lab-version{display:inline-flex;align-items:center;padding:3px 6px;border-radius:999px;border:1px solid rgba(245,158,11,.35);background:rgba(245,158,11,.08);color:#fde68a;font-size:.55rem;font-weight:850;margin-left:6px}
...
<g fill="#fff" filter="url(#labSoftGlow)"><path d="m103 177 6 13 13 6-13 6-6 13-6-13-13-6 13-6Z"/><path d="m471 55 5 11 11 5-11 5-5 11-5-11-11-5 11-5Z"/><circle cx="89" cy="132" r="4"/><circle cx="533" cy="74" r="4"/><circle cx="238" cy="44" r="3"/></g>
    ...
    <div class="lab-grid2">
        ...
        <section class="lab-panel"><div class="lab-panel-head"><h2>Aprovações</h2><button class="lab-link" data-go="aprovacoes">Ver todas ›</button></div><div class="lab-grid3">
            <div class="lab-card"><div class="lab-social-icon instagram" aria-label="Instagram"><svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="1.9"><rect x="4" y="4" width="16" height="16" rx="5"/><circle cx="12" cy="12" r="3.5"/><circle cx="17.2" cy="6.8" r="1" fill="white" stroke="none"/></svg></div><h3>Tendências que movem marcas <span class="lab-version">v2</span></h3><p>Instagram · Carrossel</p><button class="lab-action ok">Aprovar</button> <button class="lab-action adjust">Ajuste</button></div>
            <div class="lab-card"><div class="lab-social-icon facebook" aria-label="Facebook"><svg viewBox="0 0 24 24" fill="white"><path d="M14.2 8.2V6.9c0-.7.5-.9 1.1-.9h2V3h-2.7c-3 0-3.8 1.8-3.8 3.7v1.5H9v3h1.8V21h3.4v-9.8h2.7l.4-3h-3.1Z"/></svg></div><h3>3 dicas para mais engajamento <span class="lab-version">v1</span></h3><p>Facebook · Imagem</p><button class="lab-action ok">Aprovar</button> <button class="lab-action adjust">Ajuste</button></div>
            <div class="lab-card"><div class="lab-social-icon tiktok" aria-label="TikTok"><svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="1.9"><path d="M14 4v9.2a4.2 4.2 0 1 1-3.2-4.1"/><path d="M14 4c.7 2.4 2.2 3.8 4.5 4.2"/></svg></div><h3>Bastidores <span class="lab-version">v3</span></h3><p>TikTok · Vídeo</p><button class="lab-action ok">Aprovar</button> <button class="lab-action adjust">Ajuste</button></div>
        </div></section>
    </div>
</section>
...
<div class="lab-card"><div class="lab-social-icon instagram" aria-label="Instagram"><svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="1.9"><rect x="4" y="4" width="16" height="16" rx="5"/><circle cx="12" cy="12" r="3.5"/><circle cx="17.2" cy="6.8" r="1" fill="white" stroke="none"/></svg></div><h3>Tendências que movem marcas <span class="lab-version">v2</span></h3><p>Instagram · Carrossel · publica dia 16</p><button class="lab-action ok">Aprovar</button> <button class="lab-action adjust">Pedir ajuste</button></div>
<div class="lab-card"><div class="lab-social-icon facebook" aria-label="Facebook"><svg viewBox="0 0 24 24" fill="white"><path d="M14.2 8.2V6.9c0-.7.5-.9 1.1-.9h2V3h-2.7c-3 0-3.8 1.8-3.8 3.7v1.5H9v3h1.8V21h3.4v-9.8h2.7l.4-3h-3.1Z"/></svg></div><h3>3 dicas para mais engajamento <span class="lab-version">v1</span></h3><p>Facebook · Imagem · publica dia 17</p><button class="lab-action ok">Aprovar</button> <button class="lab-action adjust">Pedir ajuste</button></div>
<div class="lab-card"><div class="lab-social-icon tiktok" aria-label="TikTok"><svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="1.9"><path d="M14 4v9.2a4.2 4.2 0 1 1-3.2-4.1"/><path d="M14 4c.7 2.4 2.2 3.8 4.5 4.2"/></svg></div><h3>Bastidores <span class="lab-version">v3</span></h3><p>TikTok · Vídeo · publica dia 14</p><button class="lab-action ok">Aprovar</button> <button class="lab-action adjust">Pedir ajuste</button></div>
</div></section></section>
